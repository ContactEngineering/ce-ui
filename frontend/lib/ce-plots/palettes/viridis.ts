 ...
 * Goes from dark purple through blue and green to bright yellow.
 */

export const VIRIDIS_256: string[] = [
    ...
    '#453681', '#453882', '#443983', '#443a83', '#443b84', '#433d84', '#433e85', '#423f85',
    ...
    '#50c46a', '#52c569', '#54c568', '#56c667', '#58c765', '#5bc864', '#5dc863', '#5fc962',
    '#61ca60', '#64cb5f', '#66cb5e', '#68cc5d', '#6acd5b', '#6dcd5a', '#6fce59', '#72cf57',
    '#74d056', '#77d055', '#79d153', '#7cd252', '#7ed250', '#81d34f', '#84d34d', '#86d44c',
    '#89d54a', '#8bd549', '#8ed647', '#91d646', '#93d744', '#96d843', '#99d841', '#9bd940',
    '#9ed93e', '#a1da3d', '#a4da3b', '#a6db3a', '#a9db38', '#acdc37', '#afdc35', '#b1dd34',
    '#b4dd33', '#b7de31', '#bade30', '#bcdf2f', '#bfdf2e', '#c2df2d', '#c4e02d', '#c7e02c',
    '#cae02c', '#cde12b', '#cfe12b', '#d2e12b', '#d5e21b', '#d7e21b', '#dae31b', '#dde31c',
    '#dfe31d', '#e2e41e', '#e5e41f', '#e7e420', '#eae522', '#ece523', '#efe525', '#f1e527',
    '#f4e629', '#f6e62b', '#f8e62d', '#fbe72f', '#fde731', '#ffe733', '#ffe835', '#ffe838'
];

export default VIRIDIS_256;
