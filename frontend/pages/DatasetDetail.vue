...
import BandwidthPlot from '@/components/manager/BandwidthPlot.vue';
import CitationCard from '@/components/manager/CitationCard.vue';
import DatasetDescription from '@/components/manager/DatasetDescription.vue';
import DatasetPermissions from '@/components/manager/DatasetPermissions.vue';
import DatasetProperties from '@/components/manager/DatasetProperties.vue';
...
function resetBatchEdit() {
    // Reset selection and the batch edit topography template, close the modal
...
const selectedCount = computed(() => {
    return _selected.value.filter(Boolean).length;
});
...
const someSelected = computed(() => {
    return anySelected.value && selectedCount.value < measurementCount.value;
});

const allSelected = computed({
    get() {
        return _selected.value.every(Boolean);
    },
    set(value) {
                ...
                <BTabs class="nav-pills-custom"
                    ...
                    <BTab title="Measurements">
                        ...
                        <BModal v-model="_showBatchEditModal"
                                ...
                                size="xl"
                                no-header-close>
                            <TopographyUpdateCard v-model:topography="_batchEditTopography"
                                                  v-model:active-tab="batchActiveTab"
                                                  :batch-edit="true"
